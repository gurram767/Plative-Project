...
public class KeywordUtil extends Utility {
	 ...
	 * @throws Exception
	 */
	public static WebElement findWithFluentWait(By locator, int seconds, int poolingMil) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static WebElement findWithFluentWait(By locator) throws Exception {
		// If implicit wait is set then fluent wait will not work
