...
import enh.web.pages.smith_deletesite_Details;
...
public class SMITHS_TC_DeleteSiteDetails  extends KeywordUtil{
	String stepInfo="";
	int retryCount=getIntValue("retryCount");
	static int retryingNumber=1;
	@DataProvider
	public Object[][] testData() throws Exception {
		Object data[][] = TestDataProvider.excelReader(ConfigReader.getValue("testDataExcelPath"), "Sitedelete");
	...
	public void test(String sitename, String siterank, String output) throws Throwable {
		try{
			...
			*/
			...
			smith_deletesite_Details.deletesite(sitename, output);
