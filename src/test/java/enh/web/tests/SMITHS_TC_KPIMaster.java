...
import enh.web.pages.smith_Kpi_master;
...
public class SMITHS_TC_KPIMaster extends KeywordUtil {
	String stepInfo="";
	int retryCount=getIntValue("retryCount");
	static int retryingNumber=1;

	@Test(
			testName="SMITHS_TC_KPIMaster",
			groups={"Regression"}, 
	...
	public void test() throws Throwable {
		try{
			...
			*/
			...
			smith_Kpi_master.addKpiDetails("Sales Revenue", "FY 2024", "04", "KPI_Sitedetails_Enhops7", "745", "002", "745");
