...
public class SMITHS_TC_AddSitedetails extends KeywordUtil {
	String stepInfo="";
	int retryCount=getIntValue("retryCount");
	static int retryingNumber=1;
	@DataProvider
	public Object[][] testData() throws Exception {
		Object data[][] = TestDataProvider.excelReader(ConfigReader.getValue("testDataExcelPath"), "Siteadd");

		// System.out.println(Repository.getProperty("SSTestDataFilePath"));
		return data;
	}

	@Test( dataProvider = "testData", testName="SMITHS_TC_SITEADD",
			groups={"Regression"}, 
			description="Login : Verify whether user is able to login with valid username and password."
			)
	public void test(String sitename, String siterank) throws Throwable {
		try{
